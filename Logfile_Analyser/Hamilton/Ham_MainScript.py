...
from Logfile_Analyser.Hamilton import Ham_Config as config
from Logfile_Analyser.Hamilton.Ham_ParseLogs import run_parser
...
logger = get_logger("Hamilton_Parse")
...
if __name__ == "__main__":
    ...
    ts = slack.send_message(channel=slack_config.PRIVATE_CHANNEL_ID, text="Hamilton Logs to Slack ✅")