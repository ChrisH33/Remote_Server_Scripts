...
def add_project_to_path(project_name: str):
    """Add another project in UBUNTU folder to Python path."""
    project_root = Path(__file__).resolve().parent.parent / project_name
